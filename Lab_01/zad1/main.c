...
int take_request(struct main_array *array, char **argv, int curr_index) {
    ...
    if (strcmp(curr_value, REMOVE_BLOCK) == 0) {
        ...
        val = regexec(&regex, argv[curr_index + number_of_files + 1], 0, NULL, 0);
        if (val) {
